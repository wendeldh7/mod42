 ...
 * 
 */
package br.com.gomes.vendas.online;
...
import br.com.gomes.vendas.online.reources.ClienteResource;
import br.com.gomes.vendas.online.usecase.BuscaCliente;
import br.com.gomes.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("wendel 1").build();
